...
This repository contains the completed source code for Tutorial #2 on my YouTube channel. It demonstrates how to build a basic graphical user interface and apply OOP concepts in C#.
